...
class SearchType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
			...
			->add( 'descr', TextType::class, ['required'=>false] )
			->add( 'level', ChoiceType::class, ['choices'=>$this->options['t_level'],'required'=>false,'empty_data' =>null,'empty_value'=>'- - -','choice_attr'=>function($o,$k,$i){return ['class'=>'alert_level_'.$k];}] )
			->add( 'status', ChoiceType::class, ['choices'=>$this->options['t_status'],'required'=>false,'empty_data' =>null,'empty_value'=>'- - -','choice_attr'=>function($o,$k,$i){return ['class'=>'alert_status_'.$k];}] )
