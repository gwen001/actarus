...
namespace ArusBucketBundle\Form;
...
class SearchType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add( 'status', ChoiceType::class, ['choices'=>$this->options['t_status'],'required'=>false,'empty_data' =>null,'empty_value'=>'- - -','choice_attr'=>function($o,$k,$i){return ['class'=>'bucket_status_'.$k];}] )
